...
describe "multiply" do
  ...
  it "multiplies several numbers" do
    multiply(7, 3, 4).should == 84
  end
end

describe "power" do
  
  it "all numbers raised to power of 0 equal 1" do
    power(9,0).should == 1 && power(500, 0).should == 1
  end

  it "raises one number to the power of the second" do
    power(4,2).should == 16
  end

  it "raises one number to the power of a float" do
    power(4,0.5).should == 2
  end
end
